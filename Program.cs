...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Ridho", 18);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Purnawarman", 36, "190345", "Information Technology");
            teacher.GetNameAndAge();

            Student student = new Student("Muhammad Ridho Herprabowo", 18, "19.11.2792", "muhammad.he@students.amikom.ac.id");
